...
class BaseConfig(object):
    ...
    SQLALCHEMY_TRACK_MODIFICATIONS = config('SQLALCHEMY_TRACK_MODIFICATIONS', False, cast=bool)
...
class TestingConfig(BaseConfig):
    ...
    DEBUG_TB_ENABLED = config('DEBUG_TB_ENABLED', False, cast=bool)
    PRESERVE_CONTEXT_ON_EXCEPTION = config('PRESERVE_CONTEXT_ON_EXCEPTION', False, cast=bool)
